...
class AnimationController {
    ...
    private setupTimeline() {
        this.timeline
            .to(this, { time: 1, duration: 15, repeat: -1, ease: "none", onUpdate: () => this.render() })
    }
    ...
    public render() {
        ...
        ctx.fillStyle = '#F8F8F8' // Light background color
        ...
        // 绘制星星
        ctx.fillStyle = 'black' // Dark color for stars
    ...
    private drawTrail(t1: number) {
        for (let i = 0; i < this.trailLength; i++) {
            ...
            this.ctx.fillStyle = 'black' // Dark color for trail
            this.ctx.lineWidth = sw
...
class Star {
    ...
    render(p: number, controller: AnimationController) {
        ...
        if (q > 0) {
            ...
            const dotSize = 12.5 * this.strokeWeightFactor * sizeMultiplier; // Increased dot size
