...
export function ParticleHeroOriginal() {
  ...
  return (
    <div
      className={`relative h-full w-full overflow-hidden ${isGoldMode ? "gold-mode" : ""}`}
      style={{
        background: "#05060f",
...
interface ParticleHeroBackgroundProps {
  children?: React.ReactNode;
}

export const ParticleHeroBackground: React.FC<ParticleHeroBackgroundProps> = ({ children }) => {
  return (
    <div className="relative w-full h-full overflow-hidden">
      <ParticleHeroOriginal /> {/* The original component includes its own content and styles */}
