ALTER TABLE public.invitations
  ...
  ADD COLUMN IF NOT EXISTS agreed_rent numeric(12,2),
  ADD COLUMN IF NOT EXISTS deposit_amount numeric(12,2) NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS billing_frequency billing_frequency_enum NOT NULL DEFAULT 'MONTHLY',
  ADD COLUMN IF NOT EXISTS period_anchor_day integer CHECK (period_anchor_day BETWEEN 1 AND 31);
...
BEGIN
  ...
  IF v_inv.unit_id IS NOT NULL AND v_inv.role = 'TENANT' THEN
    ...
    INSERT INTO tenancies (
      ...
      status, created_by, billing_frequency, period_anchor_day
    )
    SELECT
      v_inv.org_id,
      v_inv.unit_id,
